...
def synth_to_real_test(device, synth_data_file, scale_to_range=False):
    batch_size = 512
    epochs = 10  # 24
    lr = 0.5
    momentum = 0.9
    ...
    test_loader, _ = load_cifar10(32, '../data', False, batch_size, 2, labeled=True, test_set=True,
...
def main():
    ...
    train_loader, _ = load_cifar10(32, '../data', False, batch_size, 2, labeled=True, test_set=False)
    test_loader, _ = load_cifar10(32, '../data', False, batch_size, 2, labeled=True, test_set=True)
