...
def parse():
    ...
    parser.add_argument('--skip-gen-to-real', action='store_true', default=False,
    ...
    parser.add_argument('--norm-data', action='store_true', default=False,
                        help='if true, normalize data (mostly debug)')

    parser.add_argument('--new-model-specs', action='store_true', default=False,
                        help='old: dp-merf AISTATS, new: experimental')
