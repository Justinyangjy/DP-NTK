    ...
    if n_classes == 2:
        ...
        for model in models_to_test:
            ...
            if str(model)[0:11] == 'BernoulliNB':
                ...
                print('training again')
                model = LinearSVC(max_iter=10000, tol=1e-1, loss='hinge')
                model.fit(X_tr, y_tr)
                pred = model.predict(X_te)  # test on real data
                print("pred", pred[:15])
                f1score1 = f1_score(y_te, pred, average='weighted')
                ...
                print('training again')
                model = LinearSVC(max_iter=10000, tol=1e-2, loss='hinge')
                model.fit(X_tr, y_tr)
                pred = model.predict(X_te)  # test on real data
                f1score1 = f1_score(y_te, pred, average='weighted')
                print(f1score1)
                ...
                print('training again')
                model = LinearSVC(max_iter=10000, tol=1e-4, loss='hinge')
                model.fit(X_tr, y_tr)
                pred = model.predict(X_te)  # test on real data
                f1score1 = f1_score(y_te, pred, average='weighted')
                print(f1score1)
                ...
                print('training again')
                model = LinearSVC(max_iter=10000, tol=1e-6, loss='hinge')
                model.fit(X_tr, y_tr)
                pred = model.predict(X_te)  # test on real data
                f1score1 = f1_score(y_te, pred, average='weighted')
                print(f1score1)
                ...
                print('training again')
                model = LinearSVC(max_iter=10000, tol=1e-12, multi_class='ovr')
                model.fit(X_tr, y_tr)
                pred = model.predict(X_te)  # test on real data
                f1score4 = f1_score(y_te, pred, average='weighted')
                print(f1score4)
                ...
                print(f1score, f1score1, f1score2, f1score3)
