...
def load_dataset(dataset_name, image_size, center_crop_size, dataroot, use_autoencoder, batch_size,
    ...
    if dataset_name in ['celeba']:
        ...
        return load_cifar10(image_size, dataroot, use_autoencoder, batch_size, n_workers, labeled,test_set)
...
def load_cifar10(image_size, dataroot, use_autoencoder, batch_size,
    ...
    test_dataset = dset.CIFAR10(root=dataroot, train=False, download=True,
                           transform=transforms.Compose(transformations))
