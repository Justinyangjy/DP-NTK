...
def main(data=None):
    ...
    if ar.data == 'cifar10':
        train_loader, n_classes, test_loader = load_cifar10(image_size=32, dataroot=ar.log_dir, use_autoencoder=False,
        ...
        train_loader, test_loader, trn_data, tst_data = get_mnist_dataloaders(ar.batch_size, ar.test_batch_size,
                                                                              use_cuda=True, dataset=ar.data,
                                                                              normalize=False, return_datasets=True)
        input_dim = 784
        n_train = 60_000
        n_classes = 10
        eval_func = None
